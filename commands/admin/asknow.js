...
async function handleAsknow(interaction, discordClient) {
    ...
    if (state.activeOnDemandPoll) return interaction.reply({ content: "There's already an active on-demand poll. Use `/resolve poll:on-demand` to end it.", ephemeral: true });
